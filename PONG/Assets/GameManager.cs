...
public class GameManager : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        if (isDebugWindowShown)
        {
            ...
            float impulsePlayer1X = player1.LastContackPoint.normalImpulse;
            float impulsePlayer1Y = player1.LastContackPoint.tangentImpulse;
            float impulsePlayer2X = player2.LastContackPoint.normalImpulse;
            float impulsePlayer2Y = player2.LastContackPoint.tangentImpulse;
